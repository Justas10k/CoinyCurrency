      ...
      <div className='Contact-us con'>
        <div className='Contact-us-container'>
          <div className='Contact-us-container-form'>
            <form className="Send-form" action="https://formsubmit.co/463816f670e58b02d689e7b3bfc14222" method="POST">
              ...
              <textarea id="message" name="message" rows="4" placeholder='I need help with...' required></textarea>
          ...
          <div className='Contact-us-container-info'>
            ...
            <a className="Contact-links color-blue" href="mailto:">Coinycurrency@gmail.com</a>
